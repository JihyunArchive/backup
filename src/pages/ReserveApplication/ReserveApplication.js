...
const ReserveApplication = () => {
    ...
    const reserveApplicationtotalMembers = reserveApplicationList.reduce((total, item) => total + item.bookMembers, 0);
                ...
                <section className="reserveApplicationList">
                    ...
                    <div className="reserveApplicationListGroup">
                        ...
                        <div className="reserveApplicationListHeaderGroup">
                            ...
                            <div className="reserveApplicationHeaderTitle">예약 신청</div>
                        </div>
                        <div className="reserveApplicationInfoGroup">
                            ...
                            <div className="reserveApplicationInfoTop">
                                <div className="reserveApplicationInfoTopGroup">
                                    ...
                                    <div className="reserveApplicationTotalTeamMember">
                                        <div className="reserveApplicationTotalTeamTitle">{`총 ${reserveApplicationList.length}팀 `}</div>
                                        <div className="reserveApplicationTotalTeamMemberDot" />
                                        <div className="reserveApplicationTotalMemberTitle">{`${reserveApplicationtotalMembers}명 `}</div>
                                    </div>
                                </div>
                            </div>        
                                        ...
                                        <div className="reserveApplicationGroupTop">
                                            <div className="reserveApplicationDateButtonGroup">
                                                ...
                                                <div className="reserveApplicationButtonGroup">
                                                    <button className="reserveApFixButton" onClick={() => handlefixButtonClick(item.bookPhoneNumber)}>
                                                        <div className="reserveApFixButtonBox" />
                                                        <div className="reserveApFixButtonTitle">확정</div>
                                                    </button>
                                                    <button className="reserveApCancleButton" onClick={() => handleCancelButtonClick(item.bookPhoneNumber)}>
                                                        <div className="reserveApCancleButtonBox" />
                                                        <div className="reserveApCancleButtonTitle">취소</div>
                                                    </button>
                                                </div>
                                            </div>
